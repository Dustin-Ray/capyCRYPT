...
mod e521_tests {
    ...
    use cryptotool::{curve::e521::e521::{
        get_e521_gen_point, 
        get_e521_id_point, 
        negate_point, 
        e521_equals, PointOps}};
    ...
    fn test_four_g_not_id() {
        let four_g = get_e521_gen_point(false).sec_mul(BigInt::from(4));
        let id = get_e521_id_point();
    ...
    fn test_ktp() {
        ...
        for _ in 0..20 {
            ...
            let k_t_mod_r_g = get_e521_gen_point(false).sec_mul((k_3*t_3).mod_floor(&r));
