...
fn bench_sign_verify(c: &mut Criterion) {
    c.bench_function("e222 + SHA3-224 Sign + Verify Roundtrip 5mb", |b| {
        b.iter(|| {
            sign_verify(
                KeyPair::new(
                    &get_random_bytes(16),
...
fn bench_sym_enc(c: &mut Criterion) {
    c.bench_function("SHA3-224 Symmetric enc + dec 5mb", |b| {
        b.iter(|| {
            sym_enc(
...
fn bench_key_gen_enc_dec(c: &mut Criterion) {
    c.bench_function("e222 + SHA3-224 Asymmetric enc + dec 5mb", |b| {
        b.iter(|| {
            key_gen_enc_dec(
                &mut KeyPair::new(
                    &get_random_bytes(32),
