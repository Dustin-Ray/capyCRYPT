...
fn bench_sym_enc(c: &mut Criterion) {
    c.bench_function("SHA3-512 Symmetric enc + dec", |b| {
        b.iter(|| {
            sym_enc(
...
fn bench_key_gen_enc_dec(c: &mut Criterion) {
    c.bench_function("e222 + SHA3-512 Asymmetric enc + dec", |b| {
        b.iter(|| {
            key_gen_enc_dec(
...
fn bench_sign_verify(c: &mut Criterion) {
    c.bench_function("e222 + SHA3-512 Sign + Verify Roundtrip", |b| {
        b.iter(|| {
            sign_verify(
